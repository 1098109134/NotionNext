...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'materry', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BlackCatCafe', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'blackcatcafe.club', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '黑猫咖啡馆,BlackCatCafe,Notion,博客,', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'asd1098109134@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
      ...
      'live2d-widget-model-miku', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://mytwikoo.blackcatcafe.club', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
